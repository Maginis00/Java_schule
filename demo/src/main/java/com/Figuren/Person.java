...
public class Person {
    ...
    /**
     * �ndere die Farbe dieser Person in 'neueFarbe'. G�ltige Angaben sind
    ...
    private void zeichnen() {
        int bh = (int)(hoehe * 0.7);  // K�rpergr��e
        int hh = (hoehe - bh) / 2;  // halbe Kopfgr��e
    ...
    /**
     * L�sche diese Person vom Bildschirm.
     */
